...
//SMI Interface
<%console.log("DutInfo : ", + obj.nSmiRx);%>
<% for (var i = 0; i < obj.nSmiRx; i++) { %>
<% var fntype = obj.interfaces.smiRxInt[i].params.wSmiDPdata==0 ? 'ndp' : 'dp';%>
...
<% if(obj.interfaces.smiRxInt[0].params.wSmiDPUser == 0) { %>
...
<% var fntype = obj.interfaces.smiTxInt[i].params.wSmiDPdata==0 ? 'ndp' : 'dp';%>
...
<% if(obj.interfaces.smiTxInt[0].params.wSmiDPUser == 0) { %>
...
//aiu_top_0 dut(
//`ifdef USE_VIP_SNPS
//    .<%=obj.interfaces.chiInt.name%>sysco_req            (chi_if.rn_if[0].SYSCOREQ),
//    .<%=obj.interfaces.chiInt.name%>sysco_ack            (chi_if.rn_if[0].SYSCOACK),
//    .<%=obj.interfaces.chiInt.name%>rx_link_active_req   (chi_if.rn_if[0].TXLINKACTIVEREQ),
//    .<%=obj.interfaces.chiInt.name%>rx_link_active_ack   (chi_if.rn_if[0].TXLINKACTIVEACK),
//    .<%=obj.interfaces.chiInt.name%>tx_link_active_req   (chi_if.rn_if[0].RXLINKACTIVEREQ),
//    .<%=obj.interfaces.chiInt.name%>tx_link_active_ack   (chi_if.rn_if[0].RXLINKACTIVEACK),
//    .<%=obj.interfaces.chiInt.name%>rx_req_flit_pend     (chi_if.rn_if[0].TXREQFLITPEND),
//    .<%=obj.interfaces.chiInt.name%>rx_req_flitv         (chi_if.rn_if[0].TXREQFLITV),
//    .<%=obj.interfaces.chiInt.name%>rx_req_flit          (chi_if.rn_if[0].TXREQFLIT),
//    .<%=obj.interfaces.chiInt.name%>rx_req_lcrdv         (chi_if.rn_if[0].TXREQLCRDV),
//    .<%=obj.interfaces.chiInt.name%>rx_rsp_flit_pend     (chi_if.rn_if[0].TXRSPFLITPEND),
//    .<%=obj.interfaces.chiInt.name%>rx_rsp_flitv         (chi_if.rn_if[0].TXRSPFLITV),
//    .<%=obj.interfaces.chiInt.name%>rx_rsp_flit          (chi_if.rn_if[0].TXRSPFLIT),
//    .<%=obj.interfaces.chiInt.name%>rx_rsp_lcrdv         (chi_if.rn_if[0].TXRSPLCRDV),
//    .<%=obj.interfaces.chiInt.name%>rx_dat_flit_pend     (chi_if.rn_if[0].TXDATFLITPEND),
//    .<%=obj.interfaces.chiInt.name%>rx_dat_flitv         (chi_if.rn_if[0].TXDATFLITV),
//    .<%=obj.interfaces.chiInt.name%>rx_dat_flit          (chi_if.rn_if[0].TXDATFLIT),
//    .<%=obj.interfaces.chiInt.name%>rx_dat_lcrdv         (chi_if.rn_if[0].TXDATLCRDV),
//    .<%=obj.interfaces.chiInt.name%>tx_snp_flit_pend     (chi_if.rn_if[0].RXSNPFLITPEND),
//    .<%=obj.interfaces.chiInt.name%>tx_snp_flitv         (chi_if.rn_if[0].RXSNPFLITV),
//    .<%=obj.interfaces.chiInt.name%>tx_snp_flit          (chi_if.rn_if[0].RXSNPFLIT),
//    .<%=obj.interfaces.chiInt.name%>tx_snp_lcrdv         (chi_if.rn_if[0].RXSNPLCRDV),
//    .<%=obj.interfaces.chiInt.name%>tx_rsp_flit_pend     (chi_if.rn_if[0].RXSNPFLITPEND),
//    .<%=obj.interfaces.chiInt.name%>tx_rsp_flitv         (chi_if.rn_if[0].RXSNPFLITV),
//    .<%=obj.interfaces.chiInt.name%>tx_rsp_flit          (chi_if.rn_if[0].RXSNPFLIT),
//    .<%=obj.interfaces.chiInt.name%>tx_rsp_lcrdv         (chi_if.rn_if[0].RXSNPLCRDV),
//    .<%=obj.interfaces.chiInt.name%>tx_dat_flit_pend     (chi_if.rn_if[0].RXDATFLITPEND),
//    .<%=obj.interfaces.chiInt.name%>tx_dat_flitv         (chi_if.rn_if[0].RXDATFLITV),
//    .<%=obj.interfaces.chiInt.name%>tx_dat_flit          (chi_if.rn_if[0].RXDATLCRDV),
//    .<%=obj.interfaces.chiInt.name%>tx_dat_lcrdv         (chi_if.rn_if[0].RXDATLCRDV),
//`else  // USE_VIP_SNPS
    .<%=obj.interfaces.chiInt.name%>sysco_req            (m_chi_if_<%=obj.AiuInfo[obj.Id].strRtlNamePrefix%>.sysco_req),
    .<%=obj.interfaces.chiInt.name%>sysco_ack            (m_chi_if_<%=obj.AiuInfo[obj.Id].strRtlNamePrefix%>.sysco_ack),
    .<%=obj.interfaces.chiInt.name%>rx_sactive           (m_chi_if_<%=obj.AiuInfo[obj.Id].strRtlNamePrefix%>.tx_sactive),
    .<%=obj.interfaces.chiInt.name%>tx_sactive           (m_chi_if_<%=obj.AiuInfo[obj.Id].strRtlNamePrefix%>.rx_sactive),
    .<%=obj.interfaces.chiInt.name%>rx_link_active_req   (m_chi_if_<%=obj.AiuInfo[obj.Id].strRtlNamePrefix%>.tx_link_active_req),
    .<%=obj.interfaces.chiInt.name%>rx_link_active_ack   (m_chi_if_<%=obj.AiuInfo[obj.Id].strRtlNamePrefix%>.tx_link_active_ack),
    .<%=obj.interfaces.chiInt.name%>tx_link_active_req   (m_chi_if_<%=obj.AiuInfo[obj.Id].strRtlNamePrefix%>.rx_link_active_req),
    .<%=obj.interfaces.chiInt.name%>tx_link_active_ack   (m_chi_if_<%=obj.AiuInfo[obj.Id].strRtlNamePrefix%>.rx_link_active_ack),
    .<%=obj.interfaces.chiInt.name%>rx_req_flit_pend     (m_chi_if_<%=obj.AiuInfo[obj.Id].strRtlNamePrefix%>.tx_req_flit_pend),
    .<%=obj.interfaces.chiInt.name%>rx_req_flitv         (m_chi_if_<%=obj.AiuInfo[obj.Id].strRtlNamePrefix%>.tx_req_flitv),
    .<%=obj.interfaces.chiInt.name%>rx_req_flit          (m_chi_if_<%=obj.AiuInfo[obj.Id].strRtlNamePrefix%>.tx_req_flit),
    .<%=obj.interfaces.chiInt.name%>rx_req_lcrdv         (m_chi_if_<%=obj.AiuInfo[obj.Id].strRtlNamePrefix%>.tx_req_lcrdv),
    .<%=obj.interfaces.chiInt.name%>rx_rsp_flit_pend     (m_chi_if_<%=obj.AiuInfo[obj.Id].strRtlNamePrefix%>.tx_rsp_flit_pend),
    .<%=obj.interfaces.chiInt.name%>rx_rsp_flitv         (m_chi_if_<%=obj.AiuInfo[obj.Id].strRtlNamePrefix%>.tx_rsp_flitv),
    .<%=obj.interfaces.chiInt.name%>rx_rsp_flit          (m_chi_if_<%=obj.AiuInfo[obj.Id].strRtlNamePrefix%>.tx_rsp_flit),
    .<%=obj.interfaces.chiInt.name%>rx_rsp_lcrdv         (m_chi_if_<%=obj.AiuInfo[obj.Id].strRtlNamePrefix%>.tx_rsp_lcrdv),
    .<%=obj.interfaces.chiInt.name%>rx_dat_flit_pend     (m_chi_if_<%=obj.AiuInfo[obj.Id].strRtlNamePrefix%>.tx_dat_flit_pend),
    .<%=obj.interfaces.chiInt.name%>rx_dat_flitv         (m_chi_if_<%=obj.AiuInfo[obj.Id].strRtlNamePrefix%>.tx_dat_flitv),
    .<%=obj.interfaces.chiInt.name%>rx_dat_flit          (m_chi_if_<%=obj.AiuInfo[obj.Id].strRtlNamePrefix%>.tx_dat_flit),
    .<%=obj.interfaces.chiInt.name%>rx_dat_lcrdv         (m_chi_if_<%=obj.AiuInfo[obj.Id].strRtlNamePrefix%>.tx_dat_lcrdv),
    .<%=obj.interfaces.chiInt.name%>tx_snp_flit_pend     (m_chi_if_<%=obj.AiuInfo[obj.Id].strRtlNamePrefix%>.rx_snp_flit_pend),
    .<%=obj.interfaces.chiInt.name%>tx_snp_flitv         (m_chi_if_<%=obj.AiuInfo[obj.Id].strRtlNamePrefix%>.rx_snp_flitv),
    .<%=obj.interfaces.chiInt.name%>tx_snp_flit          (m_chi_if_<%=obj.AiuInfo[obj.Id].strRtlNamePrefix%>.rx_snp_flit),
    .<%=obj.interfaces.chiInt.name%>tx_snp_lcrdv         (m_chi_if_<%=obj.AiuInfo[obj.Id].strRtlNamePrefix%>.rx_snp_lcrdv),
    .<%=obj.interfaces.chiInt.name%>tx_rsp_flit_pend     (m_chi_if_<%=obj.AiuInfo[obj.Id].strRtlNamePrefix%>.rx_rsp_flit_pend),
    .<%=obj.interfaces.chiInt.name%>tx_rsp_flitv         (m_chi_if_<%=obj.AiuInfo[obj.Id].strRtlNamePrefix%>.rx_rsp_flitv),
    .<%=obj.interfaces.chiInt.name%>tx_rsp_flit          (m_chi_if_<%=obj.AiuInfo[obj.Id].strRtlNamePrefix%>.rx_rsp_flit),
    .<%=obj.interfaces.chiInt.name%>tx_rsp_lcrdv         (m_chi_if_<%=obj.AiuInfo[obj.Id].strRtlNamePrefix%>.rx_rsp_lcrdv),
    .<%=obj.interfaces.chiInt.name%>tx_dat_flit_pend     (m_chi_if_<%=obj.AiuInfo[obj.Id].strRtlNamePrefix%>.rx_dat_flit_pend),
    .<%=obj.interfaces.chiInt.name%>tx_dat_flitv         (m_chi_if_<%=obj.AiuInfo[obj.Id].strRtlNamePrefix%>.rx_dat_flitv),
    .<%=obj.interfaces.chiInt.name%>tx_dat_flit          (m_chi_if_<%=obj.AiuInfo[obj.Id].strRtlNamePrefix%>.rx_dat_flit),
    .<%=obj.interfaces.chiInt.name%>tx_dat_lcrdv         (m_chi_if_<%=obj.AiuInfo[obj.Id].strRtlNamePrefix%>.rx_dat_lcrdv),
    <%if (obj.interfaces.chiInt.params.checkType !== "NONE") {%>
        .<%=obj.interfaces.chiInt.name%>tx_sactive_chk            (m_chi_if_<%=obj.AiuInfo[obj.Id].strRtlNamePrefix%>.rx_sactive_chk),
        .<%=obj.interfaces.chiInt.name%>rx_sactive_chk            (m_chi_if_<%=obj.AiuInfo[obj.Id].strRtlNamePrefix%>.tx_sactive_chk),
        .<%=obj.interfaces.chiInt.name%>sysco_req_chk             (m_chi_if_<%=obj.AiuInfo[obj.Id].strRtlNamePrefix%>.sysco_req_chk),
        .<%=obj.interfaces.chiInt.name%>sysco_ack_chk             (m_chi_if_<%=obj.AiuInfo[obj.Id].strRtlNamePrefix%>.sysco_ack_chk),
        .<%=obj.interfaces.chiInt.name%>tx_link_active_req_chk    (m_chi_if_<%=obj.AiuInfo[obj.Id].strRtlNamePrefix%>.rx_link_active_req_chk),
        .<%=obj.interfaces.chiInt.name%>tx_link_active_ack_chk    (m_chi_if_<%=obj.AiuInfo[obj.Id].strRtlNamePrefix%>.rx_link_active_ack_chk),
        .<%=obj.interfaces.chiInt.name%>rx_link_active_req_chk    (m_chi_if_<%=obj.AiuInfo[obj.Id].strRtlNamePrefix%>.tx_link_active_req_chk),
        .<%=obj.interfaces.chiInt.name%>rx_link_active_ack_chk    (m_chi_if_<%=obj.AiuInfo[obj.Id].strRtlNamePrefix%>.tx_link_active_ack_chk),
        .<%=obj.interfaces.chiInt.name%>rx_req_flit_pend_chk      (m_chi_if_<%=obj.AiuInfo[obj.Id].strRtlNamePrefix%>.tx_req_flit_pend_chk),
        .<%=obj.interfaces.chiInt.name%>rx_req_flitv_chk          (m_chi_if_<%=obj.AiuInfo[obj.Id].strRtlNamePrefix%>.tx_req_flitv_chk),
        .<%=obj.interfaces.chiInt.name%>rx_req_flit_chk           (m_chi_if_<%=obj.AiuInfo[obj.Id].strRtlNamePrefix%>.tx_req_flit_chk),
        .<%=obj.interfaces.chiInt.name%>rx_req_lcrdv_chk          (m_chi_if_<%=obj.AiuInfo[obj.Id].strRtlNamePrefix%>.tx_req_lcrdv_chk),
        .<%=obj.interfaces.chiInt.name%>rx_rsp_flit_pend_chk      (m_chi_if_<%=obj.AiuInfo[obj.Id].strRtlNamePrefix%>.tx_rsp_flit_pend_chk),
        .<%=obj.interfaces.chiInt.name%>rx_rsp_flitv_chk          (m_chi_if_<%=obj.AiuInfo[obj.Id].strRtlNamePrefix%>.tx_rsp_flitv_chk),
        .<%=obj.interfaces.chiInt.name%>rx_rsp_flit_chk           (m_chi_if_<%=obj.AiuInfo[obj.Id].strRtlNamePrefix%>.tx_rsp_flit_chk),
        .<%=obj.interfaces.chiInt.name%>rx_rsp_lcrdv_chk          (m_chi_if_<%=obj.AiuInfo[obj.Id].strRtlNamePrefix%>.tx_rsp_lcrdv_chk),
        .<%=obj.interfaces.chiInt.name%>rx_dat_flit_pend_chk      (m_chi_if_<%=obj.AiuInfo[obj.Id].strRtlNamePrefix%>.tx_dat_flit_pend_chk),
        .<%=obj.interfaces.chiInt.name%>rx_dat_flitv_chk          (m_chi_if_<%=obj.AiuInfo[obj.Id].strRtlNamePrefix%>.tx_dat_flitv_chk),
        .<%=obj.interfaces.chiInt.name%>rx_dat_flit_chk           (m_chi_if_<%=obj.AiuInfo[obj.Id].strRtlNamePrefix%>.tx_dat_flit_chk),
        .<%=obj.interfaces.chiInt.name%>rx_dat_lcrdv_chk          (m_chi_if_<%=obj.AiuInfo[obj.Id].strRtlNamePrefix%>.tx_dat_lcrdv_chk),
        .<%=obj.interfaces.chiInt.name%>tx_rsp_flit_pend_chk      (m_chi_if_<%=obj.AiuInfo[obj.Id].strRtlNamePrefix%>.rx_rsp_flit_pend_chk),
        .<%=obj.interfaces.chiInt.name%>tx_rsp_flitv_chk          (m_chi_if_<%=obj.AiuInfo[obj.Id].strRtlNamePrefix%>.rx_rsp_flitv_chk),
        .<%=obj.interfaces.chiInt.name%>tx_rsp_flit_chk           (m_chi_if_<%=obj.AiuInfo[obj.Id].strRtlNamePrefix%>.rx_rsp_flit_chk),
        .<%=obj.interfaces.chiInt.name%>tx_rsp_lcrdv_chk          (m_chi_if_<%=obj.AiuInfo[obj.Id].strRtlNamePrefix%>.rx_rsp_lcrdv_chk),
        .<%=obj.interfaces.chiInt.name%>tx_dat_flit_pend_chk      (m_chi_if_<%=obj.AiuInfo[obj.Id].strRtlNamePrefix%>.rx_dat_flit_pend_chk),
        .<%=obj.interfaces.chiInt.name%>tx_dat_flitv_chk          (m_chi_if_<%=obj.AiuInfo[obj.Id].strRtlNamePrefix%>.rx_dat_flitv_chk),
        .<%=obj.interfaces.chiInt.name%>tx_dat_flit_chk           (m_chi_if_<%=obj.AiuInfo[obj.Id].strRtlNamePrefix%>.rx_dat_flit_chk),
        .<%=obj.interfaces.chiInt.name%>tx_dat_lcrdv_chk          (m_chi_if_<%=obj.AiuInfo[obj.Id].strRtlNamePrefix%>.rx_dat_lcrdv_chk),
        .<%=obj.interfaces.chiInt.name%>tx_snp_flit_pend_chk      (m_chi_if_<%=obj.AiuInfo[obj.Id].strRtlNamePrefix%>.rx_snp_flit_pend_chk),
        .<%=obj.interfaces.chiInt.name%>tx_snp_flitv_chk          (m_chi_if_<%=obj.AiuInfo[obj.Id].strRtlNamePrefix%>.rx_snp_flitv_chk),
        .<%=obj.interfaces.chiInt.name%>tx_snp_flit_chk           (m_chi_if_<%=obj.AiuInfo[obj.Id].strRtlNamePrefix%>.rx_snp_flit_chk),
        .<%=obj.interfaces.chiInt.name%>tx_snp_lcrdv_chk          (m_chi_if_<%=obj.AiuInfo[obj.Id].strRtlNamePrefix%>.rx_snp_lcrdv_chk),
    <% } %>
...
<% if(obj.interfaces.smiTxInt[i].params.wSmiUser >0) {%>
.<%=obj.interfaces.smiTxInt[i].name %>ndp_msg_user         (m_smi<%=i%>_rx_vif.smi_msg_user  ) ,
<% } %>
<% if(obj.interfaces.smiTxInt[i].params.wSmiTier >0) {%>
.<%=obj.interfaces.smiTxInt[i].name%>ndp_msg_tier          (m_smi<%=i%>_rx_vif.smi_msg_tier  ) ,
<% } %>
<% if(obj.interfaces.smiTxInt[i].params.wSmiSteer >0) {%>
.<%=obj.interfaces.smiTxInt[i].name%>ndp_steer             (m_smi<%=i%>_rx_vif.smi_steer     ) ,
<% } %>
<% if(obj.interfaces.smiTxInt[i].params.wSmiPri >0) {%>
.<%=obj.interfaces.smiTxInt[i].name%>ndp_msg_pri           (m_smi<%=i%>_rx_vif.smi_msg_pri   ) ,
<% } %>
<% if(obj.interfaces.smiTxInt[i].params.wSmiMsgQos >0) {%>
.<%=obj.interfaces.smiTxInt[i].name%>ndp_msg_qos           (m_smi<%=i%>_rx_vif.smi_msg_qos   ) ,
<% } %>
.<%=obj.interfaces.smiTxInt[i].name%>ndp_ndp               (m_smi<%=i%>_rx_vif.smi_ndp[<%=obj.interfaces.smiTxInt[i].params.wSmiNDP-1%>:0]) ,
<% if(obj.interfaces.smiTxInt[i].params.wSmiErr >0) {%>
.<%=obj.interfaces.smiTxInt[i].name%>ndp_msg_err           (m_smi<%=i%>_rx_vif.smi_msg_err   ) ,
<% } %>
...
.<%=obj.interfaces.smiTxInt[i].name%>dp_data               (m_smi<%=i%>_rx_vif.smi_dp_data   ) ,
...
<% if(obj.interfaces.smiRxInt[i].params.wSmiUser >0) {%>
.<%=obj.interfaces.smiRxInt[i].name%>ndp_msg_user          (m_smi<%=i%>_tx_vif.smi_msg_user  ) ,
<% } %>
<% if(obj.interfaces.smiRxInt[i].params.wSmiTier >0) {%>
.<%=obj.interfaces.smiRxInt[i].name%>ndp_msg_tier          (m_smi<%=i%>_tx_vif.smi_msg_tier  ) ,
<% } %>
<% if(obj.interfaces.smiRxInt[i].params.wSmiSteer >0) {%>
.<%=obj.interfaces.smiRxInt[i].name%>ndp_steer             (m_smi<%=i%>_tx_vif.smi_steer     ) ,
<% } %>
<% if(obj.interfaces.smiRxInt[i].params.wSmiPri >0) {%>
.<%=obj.interfaces.smiRxInt[i].name%>ndp_msg_pri           (m_smi<%=i%>_tx_vif.smi_msg_pri   ) ,
<% } %>
<% if(obj.interfaces.smiRxInt[i].params.wSmiMsgQos >0) {%>
.<%=obj.interfaces.smiRxInt[i].name%>ndp_msg_qos           (m_smi<%=i%>_tx_vif.smi_msg_qos   ) ,
<% } %>
...
.<%=obj.interfaces.smiRxInt[i].name%>ndp_msg_err           (m_smi<%=i%>_tx_vif.smi_msg_err   ) ,
<% } %>
...
.<%=obj.interfaces.smiRxInt[i].name%>dp_data               (m_smi<%=i%>_tx_vif.smi_dp_data   ) ,
...
<% } %>
    ...
    .<%=obj.interfaces.clkInt.name%>test_en                  ('h0),
    .<%=obj.interfaces.uIdInt.name%>my_f_unit_id         (<%=obj.DutInfo.FUnitId%>),
    .<%=obj.interfaces.uIdInt.name%>my_n_unit_id         (<%=obj.DutInfo.nUnitId%>),
    .<%=obj.interfaces.uIdInt.name%>my_csr_rpn           (<%=obj.DutInfo.rpn%>) ,
    .<%=obj.interfaces.uIdInt.name%>my_csr_nrri          (<%=obj.DutInfo.nrri%>) ,
    .<%=obj.interfaces.uSysDceIdInt.name%>f_unit_id        (DCE_FUNIT_IDS),
    .<%=obj.interfaces.uSysDveIdInt.name%>f_unit_id        (DVE_FUNIT_IDS),
    .<%=obj.interfaces.uSysDmiIdInt.name%>f_unit_id        (DMI_FUNIT_IDS),
    .<%=obj.interfaces.uSysDiiIdInt.name%>f_unit_id        (DII_FUNIT_IDS),
    .<%=obj.interfaces.uSysCAiuIdInt.name%>f_unit_id        (CACHING_AIU_FUNIT_IDS),
    .<%=obj.interfaces.uSysDceIdInt.name%>connectivity      (<%=obj.BlockId%>_connectivity_if.AiuDce_connectivity_vec),  //#Stimulus.CHIAIU.v3.4.Connectivity.UnconnectedDce
    .<%=obj.interfaces.uSysDmiIdInt.name%>connectivity      (<%=obj.BlockId%>_connectivity_if.AiuDmi_connectivity_vec),  //#Stimulus.CHIAIU.v3.4.Connectivity.UnconnectedDmi
    .<%=obj.interfaces.uSysDiiIdInt.name%>connectivity      (<%=obj.BlockId%>_connectivity_if.AiuDii_connectivity_vec),  //#Stimulus.CHIAIU.v3.4.Connectivity.UnconnectedDii

    .<%=obj.interfaces.uSysConnectedDceIdInt.name%>f_unit_id    (<%=obj.BlockId%>_connectivity_if.AiuConnectedDceFunitId),
    .<%=obj.interfaces.uSysConnectedDceIdInt.name%>connectivity (<%=obj.BlockId%>_connectivity_if.AiuDce_connectivity_vec),


<%  if(obj.INHOUSE_APB_VIP && obj.testBench=="chi_aiu") { %>
    .<%=obj.interfaces.apbInt.name%>paddr	(apb_if.paddr[<%=obj.interfaces.apbInt.params.wAddr-1%>:0]),	
    .<%=obj.interfaces.apbInt.name%>psel	(apb_if.psel),	
    .<%=obj.interfaces.apbInt.name%>penable	(apb_if.penable),
    .<%=obj.interfaces.apbInt.name%>pwrite	(apb_if.pwrite),
    .<%=obj.interfaces.apbInt.name%>pwdata	(apb_if.pwdata),
    .<%=obj.interfaces.apbInt.name%>pready	(apb_if.pready),
    .<%=obj.interfaces.apbInt.name%>prdata	(apb_if.prdata),
    .<%=obj.interfaces.apbInt.name%>pslverr	(apb_if.pslverr),
...
<% } %>
  ...
  .trigger_trigger(<%=obj.BlockId%>_sb_stall_if.master_cnt_enable),
    ...
    .<%=obj.interfaces.irqInt.name%>uc		(irq_uc),
    .<%=obj.interfaces.irqInt.name%>c        	(irq_c)
...
dut.<%=obj.interfaces.smiTxInt[0].name%>ndp_msg_valid &&
(dut.<%=obj.interfaces.smiTxInt[0].name%>ndp_msg_type inside 
...
assign <%=obj.AiuInfo[obj.Id].strRtlNamePrefix%>_sb_stall_if.cmd_req_wr_ready = dut.<%=obj.interfaces.smiTxInt[0].name%>ndp_msg_ready; 
assign <%=obj.AiuInfo[obj.Id].strRtlNamePrefix%>_sb_stall_if.cmd_req_wr_funit_id_if = (dut.<%=obj.interfaces.smiTxInt[0].name%>ndp_targ_id >> WSMINCOREPORTID); 
<% if(obj.interfaces.smiTxInt[0].params.wSmiUser >0) {%> 
assign <%=obj.AiuInfo[obj.Id].strRtlNamePrefix%>_sb_stall_if.cmd_req_wr_user_bits_if = dut.<%=obj.interfaces.smiTxInt[0].name%>ndp_ndp[CMD_REQ_NDP_AUX_MSB:CMD_REQ_NDP_AUX_LSB];
<% } %>
...
assign <%=obj.AiuInfo[obj.Id].strRtlNamePrefix%>_sb_stall_if.cmd_req_rd_ready = dut.<%=obj.interfaces.smiTxInt[0].name%>ndp_msg_ready; 
assign <%=obj.AiuInfo[obj.Id].strRtlNamePrefix%>_sb_stall_if.cmd_req_rd_funit_id_if = (dut.<%=obj.interfaces.smiTxInt[0].name%>ndp_targ_id >> WSMINCOREPORTID);
<% if(obj.interfaces.smiTxInt[0].params.wSmiUser >0) {%>
assign <%=obj.AiuInfo[obj.Id].strRtlNamePrefix%>_sb_stall_if.cmd_req_rd_user_bits_if = dut.<%=obj.interfaces.smiTxInt[0].name%>ndp_ndp[CMD_REQ_NDP_AUX_MSB:CMD_REQ_NDP_AUX_LSB];
<% } %>

//snp_rsp event
assign <%=obj.AiuInfo[obj.Id].strRtlNamePrefix%>_sb_stall_if.snp_rsp_valid =
dut.<%=obj.interfaces.smiTxInt[1].name%>ndp_msg_valid && (dut.<%=obj.interfaces.smiTxInt[1].name%>ndp_msg_type == SNP_RSP);

assign <%=obj.AiuInfo[obj.Id].strRtlNamePrefix%>_sb_stall_if.snp_rsp_ready = dut.<%=obj.interfaces.smiTxInt[1].name%>ndp_msg_ready;
assign <%=obj.AiuInfo[obj.Id].strRtlNamePrefix%>_sb_stall_if.snp_rsp_funit_id_if = (dut.<%=obj.interfaces.smiTxInt[1].name%>ndp_targ_id >> WSMINCOREPORTID) ;
<% if(obj.interfaces.smiTxInt[1].params.wSmiUser >0) {%>
assign <%=obj.AiuInfo[obj.Id].strRtlNamePrefix%>_sb_stall_if.snp_rsp_user_bits_if = 0; // dut.<%=obj.interfaces.smiTxInt[1].name%>ndp_ndp[CMD_REQ_NDP_AUX_MSB:CMD_REQ_NDP_AUX_LSB];
<% } %>
...
assign tb_sysco_req = tb_top.dut.<%=obj.interfaces.chiInt.name%>sysco_req;
assign tb_sysco_ack = tb_top.dut.<%=obj.interfaces.chiInt.name%>sysco_ack;
