...
*/
    ...
    case "gen_tb" : {
	if(args.cli.achl && (args.rtl_json || args.cli.tcl_input || args.cli.tcl_cfg) && (args.cli.skip_maestro == null) && (args.cli.environment !== 'cust_tb'))
...
*/
    ...
    case "run_test" : {
	//DCDEBUG
	if (args.cli.environment === 'cust_tb') {
...
console.log("genRalgen");
	...
	} else if((args.cli.environment == "cust_tb")) {
