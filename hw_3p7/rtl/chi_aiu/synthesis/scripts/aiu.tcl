...
set ace_ports_in [get_ports ace_* -filter {@port_direction == in}]
set ace_ports_out [get_ports ace_* -filter {@port_direction == out}]
...
set_input_delay -max [expr $INPUTDELAY*$PERIOD] -clock [get_clocks] [get_ports $ace_ports_in]
set_output_delay -max [expr $OUTPUTDELAY*$PERIOD] -clock [get_clocks] [get_ports $ace_ports_out]
