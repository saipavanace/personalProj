...
coverage exclude -code e -scope /tb_top/dut/TraceMem0 -r
coverage exclude -code c -scope /tb_top/dut/TraceMem0 -r
coverage exclude -code e -scope /tb_top/dut/TraceMem1 -r
coverage exclude -code c -scope /tb_top/dut/TraceMem1 -r

coverage exclude -code e -scope /tb_top/dut/unit/u_protman -r
coverage exclude -code c -scope /tb_top/dut/unit/u_protman -r
...
coverage exclude -code e -scope /tb_top/dut/unit/dve_concerto_mux/nc_cmd_rsp_fifo -r
...
coverage exclude -code s -scope /tb_top/dut/unit/dve_concerto_mux/nc_cmd_rsp_fifo -r

coverage exclude -code e -scope /tb_top/dut/unit/u_csr -r
coverage exclude -code c -scope /tb_top/dut/unit/u_csr -r

coverage exclude -code e -scope /tb_top/dut/unit/u_protman/skidbuf/dtwrsp_dbg_fifo -r
coverage exclude -code c -scope /tb_top/dut/unit/u_protman/skidbuf/dtwrsp_dbg_fifo -r
