...
coverage exclude -code e -scope /tb_top/dut/dup_unit/u_ncr_pmon -r
coverage exclude -code c -scope /tb_top/dut/dup_unit/u_ncr_pmon -r
...
coverage exclude -code e -scope /tb_top/dut/u_fault_checker/latent_fault_xor_tree -r
coverage exclude -code c -scope /tb_top/dut/u_fault_checker/latent_fault_xor_tree -r
coverage exclude -code e -scope /tb_top/dut/u_fault_checker/mission_fault_xor_tree -r
coverage exclude -code c -scope /tb_top/dut/u_fault_checker/mission_fault_xor_tree -r
...
coverage exclude -code e -scope /tb_top/dut/unit/u_sys_evt_coh_concerto -r
coverage exclude -code c -scope /tb_top/dut/unit/u_sys_evt_coh_concerto -r
...
coverage exclude -code e -scope /tb_top/dut/dup_unit/u_sys_evt_coh_concerto -r
coverage exclude -code c -scope /tb_top/dut/dup_unit/u_sys_evt_coh_concerto -r
...
coverage exclude -code e -scope /tb_top/dut/unit/dve_concerto_mux/sys_rsp_tx_prot_interface -r
coverage exclude -code e -scope /tb_top/dut/unit/dve_concerto_mux/snp_rsp_correct_interface -r
coverage exclude -code e -scope /tb_top/dut/unit/dve_concerto_mux/sys_req_rx_correct_interface -r
coverage exclude -code e -scope /tb_top/dut/unit/dve_concerto_mux/dtw_dbg_rsp_prot_interface -r
coverage exclude -code e -scope /tb_top/dut/unit/dve_concerto_mux/dtw_dbg_req_correct_interface -r
coverage exclude -code e -scope /tb_top/dut/unit/dve_concerto_mux/dtw_dbg_req_0_data_correct_interface -r
coverage exclude -code e -scope /tb_top/dut/unit/dve_concerto_mux/str_rsp_correct_interface -r
...
coverage exclude -code e -scope /tb_top/dut/unit/dve_concerto_mux/sys_rsp_tx_fifo -r
...
coverage exclude -code e -scope /tb_top/dut/dup_unit/dve_concerto_mux/sys_rsp_tx_prot_interface -r
coverage exclude -code e -scope /tb_top/dut/dup_unit/dve_concerto_mux/snp_rsp_correct_interface -r
coverage exclude -code e -scope /tb_top/dut/dup_unit/dve_concerto_mux/sys_req_rx_correct_interface -r
coverage exclude -code e -scope /tb_top/dut/dup_unit/dve_concerto_mux/dtw_dbg_rsp_prot_interface -r
coverage exclude -code e -scope /tb_top/dut/dup_unit/dve_concerto_mux/dtw_dbg_req_correct_interface -r
coverage exclude -code e -scope /tb_top/dut/dup_unit/dve_concerto_mux/dtw_dbg_req_0_data_correct_interface -r
coverage exclude -code e -scope /tb_top/dut/dup_unit/dve_concerto_mux/str_rsp_correct_interface -r
...
coverage exclude -code e -scope /tb_top/dut/dup_unit/dve_concerto_mux/sys_req_rx_fifo -r
coverage exclude -code e -scope /tb_top/dut/dup_unit/dve_concerto_mux/sys_rsp_tx_fifo -r
...
coverage exclude -code e -scope /tb_top/dut/dup_unit/u_protman/u_dve_trace_accumulator -r
coverage exclude -code c -scope /tb_top/dut/dup_unit/u_protman/u_dve_trace_accumulator -r
