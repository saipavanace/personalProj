...
rh.consts('DEFAULT_TOPIC', encodeURI("#Ncore_3_Online_Documentation/Welcome/Welcome.htm".substring(1)));
rh.consts('HOME_FILEPATH', encodeURI("index.html"));
rh.consts('START_FILEPATH', encodeURI('index.html'));
rh.consts('HELP_ID', 'E3228D56-8611-4D34-8AC3-E739E6CA450C' || 'preview');
...
model.publish(rh.consts('KEY_HEADER_TITLE'), "Ncore Online Documentation - version 3.7.x");
