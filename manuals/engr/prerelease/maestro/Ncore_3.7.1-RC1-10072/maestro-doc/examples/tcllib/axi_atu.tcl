...
namespace eval Axi_atu {
  ...
  set version 2.0
  set Description "Maestro_Axi_atu"

  variable home [file join [pwd] [file dirname [info script]]]
  variable created_units [list]
}

proc Axi_atu::set_pipeLevel { objList val} {
  foreach obj $objList {
...
proc Axi_atu::set_pipeLevelAtp { objList val} {
  foreach obj $objList {
    set pos [string last "/" $obj]
    incr pos
    set shortName [string range $obj $pos end]
...
proc Axi_atu::set_pipeLevelLut { objList val} {
  foreach obj $objList {
    set pos [string last "/" $obj]
    incr pos
    set shortName [string range $obj $pos end]
...
proc Axi_atu::set_maxPduSz { objList val} {
  foreach obj $objList {
    set pos [string last "/" $obj]
    incr pos
    set shortName [string range $obj $pos end]
...
proc Axi_atu::set_maxOutWr { objList val} {
  foreach obj $objList {
...
proc Axi_atu::set_maxOutRd { objList val} {
  foreach obj $objList {
...
proc Axi_atu::set_nativeType { objList val} {
  foreach obj $objList {
    set pos [string last "/" $obj]
    incr pos
    set shortName [string range $obj $pos end]
...
proc Axi_atu::set_axiWrEn { objList val} {
  foreach obj $objList {
    set pos [string last "/" $obj]
    incr pos
    set shortName [string range $obj $pos end]
...
proc Axi_atu::set_axiRdEn { objList val} {
  foreach obj $objList {
    set pos [string last "/" $obj]
    incr pos
    set shortName [string range $obj $pos end]
...
proc Axi_atu::set_axiPipeR { objList val} {
  foreach obj $objList {
    set pos [string last "/" $obj]
    incr pos
    set shortName [string range $obj $pos end]
...
proc Axi_atu::set_axiPipeB { objList val} {
  foreach obj $objList {
    set pos [string last "/" $obj]
    incr pos
    set shortName [string range $obj $pos end]
...
proc Axi_atu::set_axiPipeW { objList val} {
  foreach obj $objList {
    set pos [string last "/" $obj]
    incr pos
    set shortName [string range $obj $pos end]
...
proc Axi_atu::set_axiPipeAw { objList val} {
  foreach obj $objList {
    set pos [string last "/" $obj]
    incr pos
    set shortName [string range $obj $pos end]
...
proc Axi_atu::set_axiPipeAr { objList val} {
  foreach obj $objList {
    set pos [string last "/" $obj]
    incr pos
    set shortName [string range $obj $pos end]
...
proc Axi_atu::set_ctlPipeReq { objList val} {
  foreach obj $objList {
    set pos [string last "/" $obj]
    incr pos
    set shortName [string range $obj $pos end]
...
proc Axi_atu::set_ctlPipeResp { objList val} {
  foreach obj $objList {
    set pos [string last "/" $obj]
    incr pos
    set shortName [string range $obj $pos end]
...
proc Axi_atu::set_nodeId { objList val} {
  # foreach obj $objList {
  #   set pos [string last "/" $obj]
  #   incr pos
  #   set shortName [string range $obj $pos end]
...
proc Axi_atu::set_enBufWrite { objList val} {
  foreach obj $objList {
    set pos [string last "/" $obj]
    incr pos
    set shortName [string range $obj $pos end]
...
proc Axi_atu::set_enSplitting { objList val} {
...
proc Axi_atu::set_enReordering { objList val} {
  if {[info exists ::_skip_depreciated_] && ($::_skip_depreciated_ == 1)} {return}
  foreach obj $objList {
    set pos [string last "/" $obj]
    incr pos
...
proc Axi_atu::set_widthAdaptionSupported { objList val} {
  if {[info exists ::_skip_depreciated_] && ($::_skip_depreciated_ == 1)} {return}
  foreach obj $objList {
    set pos [string last "/" $obj]
    incr pos
...
proc Axi_atu::set_fixedSupported { objList val} {
  foreach obj $objList {
    set pos [string last "/" $obj]
    incr pos
    set shortName [string range $obj $pos end]
...
proc Axi_atu::set_incrSupported { objList val} {
  foreach obj $objList {
    set pos [string last "/" $obj]
    incr pos
    set shortName [string range $obj $pos end]
...
proc Axi_atu::set_wrapSupported { objList val} {
  foreach obj $objList {
    set pos [string last "/" $obj]
    incr pos
    set shortName [string range $obj $pos end]
...
proc Axi_atu::set_narrowSupported { objList val} {
  foreach obj $objList {
    set pos [string last "/" $obj]
    incr pos
    set shortName [string range $obj $pos end]
...
proc Axi_atu::set_readInterleaveSupported { objList val} {
  foreach obj $objList {
    set pos [string last "/" $obj]
    incr pos
    set shortName [string range $obj $pos end]
...
proc Axi_atu::set_beatBufferEntries { objList val} {
  foreach obj $objList {
    set pos [string last "/" $obj]
    incr pos
    set shortName [string range $obj $pos end]
...
proc Axi_atu::set_idCompMask { objList val} {
  if {[info exists ::_skip_depreciated_] && ($::_skip_depreciated_ == 1)} {return}
  foreach obj $objList {
    set pos [string last "/" $obj]
    incr pos
...
proc Axi_atu::set_queueMap { objList val} {
  foreach obj $objList {
    set pos [string last "/" $obj]
    incr pos
    set shortName [string range $obj $pos end]
...
proc Axi_atu::set_queueDepth { objList val} {
  if {[info exists ::_skip_depreciated_] && ($::_skip_depreciated_ == 1)} {return}
  foreach obj $objList {
    set pos [string last "/" $obj]
    incr pos
...
proc Axi_atu::set_qosMapMode { objList val} {
  if {[info exists ::_skip_depreciated_] && ($::_skip_depreciated_ == 1)} {return}
  foreach obj $objList {
    set pos [string last "/" $obj]
    incr pos
...
proc Axi_atu::set_crdMngrEn { objList val} {
  if {[info exists ::_skip_depreciated_] && ($::_skip_depreciated_ == 1)} {return}
  foreach obj $objList {
    set pos [string last "/" $obj]
    incr pos
...
proc Axi_atu::set_crdDataUnit { objList val} {
  if {[info exists ::_skip_depreciated_] && ($::_skip_depreciated_ == 1)} {return}
  foreach obj $objList {
    set pos [string last "/" $obj]
    incr pos
...
proc Axi_atu::set_atomicsSupported { objList val} {
  if {[info exists ::_skip_depreciated_] && ($::_skip_depreciated_ == 1)} {return}
  foreach obj $objList {
    set pos [string last "/" $obj]
    incr pos
...
proc Axi_atu::set_timeoutErrChk { objList val} {
  if {[info exists ::_skip_depreciated_] && ($::_skip_depreciated_ == 1)} {return}
  foreach obj $objList {
    set pos [string last "/" $obj]
    incr pos
...
proc Axi_atu::set_timeoutErrCount { objList val} {
  if {[info exists ::_skip_depreciated_] && ($::_skip_depreciated_ == 1)} {return}
  foreach obj $objList {
    set pos [string last "/" $obj]
    incr pos
...
proc Axi_atu::set_timeoutUseExternalValue { objList val} {
  return
  foreach obj $objList {
    set pos [string last "/" $obj]
    incr pos
...
proc Axi_atu::set_maxOutTotal { objList val} {
  foreach obj $objList {
...
proc Axi_atu::set_ctlPipeCtxt { objList val} {
  if {[info exists ::_skip_depreciated_] && ($::_skip_depreciated_ == 1)} {return}
  foreach obj $objList {
    set pos [string last "/" $obj]
    incr pos
...
proc Axi_atu::set_pipeLevelPam { objList val} {
  foreach obj $objList {
    set pos [string last "/" $obj]
    incr pos
    set shortName [string range $obj $pos end]
...
proc Axi_atu::set_numPri { objList val} {
  if {[info exists ::_skip_depreciated_] && ($::_skip_depreciated_ == 1)} {return}
  foreach obj $objList {
    set pos [string last "/" $obj]
    incr pos
...
proc Axi_atu::set_pktArbType { objList val} {
  if {[info exists ::_skip_depreciated_] && ($::_skip_depreciated_ == 1)} {return}
  foreach obj $objList {
    set pos [string last "/" $obj]
    incr pos
...
proc Axi_atu::set_depktArbType { objList val} {
  if {[info exists ::_skip_depreciated_] && ($::_skip_depreciated_ == 1)} {return}
  foreach obj $objList {
    set pos [string last "/" $obj]
    incr pos
...
proc Axi_atu::set_pktArbWeights { objList val} {
  foreach obj $objList {
    set pos [string last "/" $obj]
    incr pos
    set shortName [string range $obj $pos end]
    set attrKey pktArbWeights
    set_attribute -object $obj -name $attrKey -value_list $val
  }
}

proc Axi_atu::set_depktArbWeights { objList val} {
  foreach obj $objList {
    set pos [string last "/" $obj]
    incr pos
    set shortName [string range $obj $pos end]
    set attrKey depktArbWeights
    set_attribute -object $obj -name $attrKey -value_list $val
  }
}

proc Axi_atu::set_smipktArbType { objList val} {
  foreach obj $objList {
    set pos [string last "/" $obj]
    incr pos
    set shortName [string range $obj $pos end]
...
proc Axi_atu::set_smiPktweights { objList val} {
  if {[info exists ::_skip_depreciated_] && ($::_skip_depreciated_ == 1)} {return}
  foreach obj $objList {
    set pos [string last "/" $obj]
    incr pos
...
proc Axi_atu::set_smiDpkweights { objList val} {
  if {[info exists ::_skip_depreciated_] && ($::_skip_depreciated_ == 1)} {return}
  foreach obj $objList {
    set pos [string last "/" $obj]
    incr pos
...
proc Axi_atu::set_smiDpkarbType { objList val} {
  if {[info exists ::_skip_depreciated_] && ($::_skip_depreciated_ == 1)} {return}
  foreach obj $objList {
    set pos [string last "/" $obj]
    incr pos
...
proc Axi_atu::set_mstrArbLock { objList val} {
  if {[info exists ::_skip_depreciated_] && ($::_skip_depreciated_ == 1)} {return}
  foreach obj $objList {
    set pos [string last "/" $obj]
    incr pos
...
proc Axi_atu::set_lckStyleVld { objList val} {
  if {[info exists ::_skip_depreciated_] && ($::_skip_depreciated_ == 1)} {return}
  foreach obj $objList {
    set pos [string last "/" $obj]
    incr pos
...
proc Axi_atu::set_rateLmtEn { objList val} {
  if {[info exists ::_skip_depreciated_] && ($::_skip_depreciated_ == 1)} {return}
  foreach obj $objList {
    set pos [string last "/" $obj]
    incr pos
...
proc Axi_atu::set_rateLmtUseExternalValues { objList val} {
  if {[info exists ::_skip_depreciated_] && ($::_skip_depreciated_ == 1)} {return}
  foreach obj $objList {
    set pos [string last "/" $obj]
    incr pos
...
proc Axi_atu::set_rateLmtRefCntGlobal { objList val} {
  if {[info exists ::_skip_depreciated_] && ($::_skip_depreciated_ == 1)} {return}
  foreach obj $objList {
    set pos [string last "/" $obj]
    incr pos
...
proc Axi_atu::set_refreshAmtGlobal { objList val} {
  if {[info exists ::_skip_depreciated_] && ($::_skip_depreciated_ == 1)} {return}
  foreach obj $objList {
    set pos [string last "/" $obj]
    incr pos
...
proc Axi_atu::set_rateLmtBktGlobal { objList val} {
  if {[info exists ::_skip_depreciated_] && ($::_skip_depreciated_ == 1)} {return}
  foreach obj $objList {
    set pos [string last "/" $obj]
    incr pos
...
proc Axi_atu::set_enDecodeError { objList val} {
  if {[info exists ::_skip_depreciated_] && ($::_skip_depreciated_ == 1)} {return}
  foreach obj $objList {
    set pos [string last "/" $obj]
    incr pos
...
proc Axi_atu::set_wRateLmtRefCntGlobal { objList val} {
  if {[info exists ::_skip_depreciated_] && ($::_skip_depreciated_ == 1)} {return}
  foreach obj $objList {
    set pos [string last "/" $obj]
    incr pos
...
proc Axi_atu::set_wRefreshAmtGlobal { objList val} {
  if {[info exists ::_skip_depreciated_] && ($::_skip_depreciated_ == 1)} {return}
  foreach obj $objList {
    set pos [string last "/" $obj]
    incr pos
...
proc Axi_atu::set_wRateLmtBktGlobal { objList val} {
  if {[info exists ::_skip_depreciated_] && ($::_skip_depreciated_ == 1)} {return}
  foreach obj $objList {
    set pos [string last "/" $obj]
    incr pos
...
proc Axi_atu::set_wRateLmtRefCntQueue { objList val} {
  if {[info exists ::_skip_depreciated_] && ($::_skip_depreciated_ == 1)} {return}
  foreach obj $objList {
    set pos [string last "/" $obj]
    incr pos
...
proc Axi_atu::set_wRefreshAmtQueue { objList val} {
  if {[info exists ::_skip_depreciated_] && ($::_skip_depreciated_ == 1)} {return}
  foreach obj $objList {
    set pos [string last "/" $obj]
    incr pos
...
proc Axi_atu::set_wRateLmtBktQueue { objList val} {
  if {[info exists ::_skip_depreciated_] && ($::_skip_depreciated_ == 1)} {return}
  foreach obj $objList {
    set pos [string last "/" $obj]
    incr pos
...
proc Axi_atu::set_enPathLookup { objList val} {
  if {[info exists ::_skip_depreciated_] && ($::_skip_depreciated_ == 1)} {return}
  foreach obj $objList {
    set pos [string last "/" $obj]
    incr pos
...
proc Axi_atu::set_smiPktnumPri { objList val} {
  if {[info exists ::_skip_depreciated_] && ($::_skip_depreciated_ == 1)} {return}
  foreach obj $objList {
    set pos [string last "/" $obj]
    incr pos
...
proc Axi_atu::set_smiPktarbRdyAware { objList val} {
  if {[info exists ::_skip_depreciated_] && ($::_skip_depreciated_ == 1)} {return}
  foreach obj $objList {
    set pos [string last "/" $obj]
    incr pos
...
proc Axi_atu::set_smiPktweightsProg { objList val} {
  if {[info exists ::_skip_depreciated_] && ($::_skip_depreciated_ == 1)} {return}
  foreach obj $objList {
    set pos [string last "/" $obj]
    incr pos
...
proc Axi_atu::set_smiDpknumPri { objList val} {
  if {[info exists ::_skip_depreciated_] && ($::_skip_depreciated_ == 1)} {return}
  foreach obj $objList {
    set pos [string last "/" $obj]
    incr pos
...
proc Axi_atu::set_smiDpkarbRdyAware { objList val} {
  if {[info exists ::_skip_depreciated_] && ($::_skip_depreciated_ == 1)} {return}
  foreach obj $objList {
    set pos [string last "/" $obj]
    incr pos
...
proc Axi_atu::set_smiDpkweightsProg { objList val} {
  if {[info exists ::_skip_depreciated_] && ($::_skip_depreciated_ == 1)} {return}
  foreach obj $objList {
    set pos [string last "/" $obj]
    incr pos
...
proc Axi_atu::get_pipeLevel { objList } {
  set valList [list ]
  foreach obj $objList {
    set pos [string last "/" $obj]
    incr pos
...
proc Axi_atu::get_pipeLevelAtp { objList } {
  set valList [list ]
  foreach obj $objList {
    set pos [string last "/" $obj]
    incr pos
...
proc Axi_atu::get_pipeLevelLut { objList } {
  set valList [list ]
  foreach obj $objList {
    set pos [string last "/" $obj]
    incr pos
...
proc Axi_atu::get_maxPduSz { objList } {
  set valList [list ]
  foreach obj $objList {
    set pos [string last "/" $obj]
    incr pos
...
proc Axi_atu::get_nativeType { objList } {
  set valList [list ]
  foreach obj $objList {
    set pos [string last "/" $obj]
    incr pos
...
proc Axi_atu::get_axiWrEn { objList } {
  set valList [list ]
  foreach obj $objList {
    set pos [string last "/" $obj]
    incr pos
...
proc Axi_atu::get_axiRdEn { objList } {
  set valList [list ]
  foreach obj $objList {
    set pos [string last "/" $obj]
    incr pos
...
proc Axi_atu::get_axiPipeR { objList } {
  set valList [list ]
  foreach obj $objList {
    set pos [string last "/" $obj]
    incr pos
...
proc Axi_atu::get_axiPipeB { objList } {
  set valList [list ]
  foreach obj $objList {
    set pos [string last "/" $obj]
    incr pos
...
proc Axi_atu::get_axiPipeW { objList } {
  set valList [list ]
  foreach obj $objList {
    set pos [string last "/" $obj]
    incr pos
...
proc Axi_atu::get_axiPipeAw { objList } {
  set valList [list ]
  foreach obj $objList {
    set pos [string last "/" $obj]
    incr pos
...
proc Axi_atu::get_axiPipeAr { objList } {
  set valList [list ]
  foreach obj $objList {
    set pos [string last "/" $obj]
    incr pos
...
proc Axi_atu::get_ctlPipeReq { objList } {
  set valList [list ]
  foreach obj $objList {
    set pos [string last "/" $obj]
    incr pos
...
proc Axi_atu::get_ctlPipeResp { objList } {
  set valList [list ]
  foreach obj $objList {
    set pos [string last "/" $obj]
    incr pos
...
proc Axi_atu::get_nodeId { objList } {
  set valList [list ]
  foreach obj $objList {
    set pos [string last "/" $obj]
    incr pos
...
proc Axi_atu::get_enBufWrite { objList } {
  set valList [list ]
  foreach obj $objList {
    set pos [string last "/" $obj]
    incr pos
...
proc Axi_atu::get_enSplitting { objList } {
  if {[info exists ::_skip_depreciated_] && ($::_skip_depreciated_ == 1)} {return}
  set valList [list ]
  foreach obj $objList {
    set pos [string last "/" $obj]
...
proc Axi_atu::get_enReordering { objList } {
  if {[info exists ::_skip_depreciated_] && ($::_skip_depreciated_ == 1)} {return}
  set valList [list ]
  foreach obj $objList {
    set pos [string last "/" $obj]
...
proc Axi_atu::get_widthAdaptionSupported { objList } {
  if {[info exists ::_skip_depreciated_] && ($::_skip_depreciated_ == 1)} {return}
  set valList [list ]
  foreach obj $objList {
    set pos [string last "/" $obj]
...
proc Axi_atu::get_fixedSupported { objList } {
  set valList [list ]
  foreach obj $objList {
    set pos [string last "/" $obj]
    incr pos
...
proc Axi_atu::get_incrSupported { objList } {
  set valList [list ]
  foreach obj $objList {
    set pos [string last "/" $obj]
    incr pos
...
proc Axi_atu::get_wrapSupported { objList } {
  set valList [list ]
  foreach obj $objList {
    set pos [string last "/" $obj]
    incr pos
...
proc Axi_atu::get_narrowSupported { objList } {
  set valList [list ]
  foreach obj $objList {
    set pos [string last "/" $obj]
    incr pos
...
proc Axi_atu::get_readInterleaveSupported { objList } {
  set valList [list ]
  foreach obj $objList {
    set pos [string last "/" $obj]
    incr pos
...
proc Axi_atu::get_idCompMask { objList } {
  if {[info exists ::_skip_depreciated_] && ($::_skip_depreciated_ == 1)} {return}
  set valList [list ]
  foreach obj $objList {
    set pos [string last "/" $obj]
...
proc Axi_atu::get_beatBufferEntries { objList } {
  set valList [list ]
  foreach obj $objList {
    set pos [string last "/" $obj]
    incr pos
...
proc Axi_atu::get_queueDepth { objList } {
  if {[info exists ::_skip_depreciated_] && ($::_skip_depreciated_ == 1)} {return}
  set valList [list ]
  foreach obj $objList {
    set pos [string last "/" $obj]
...
proc Axi_atu::get_qosMapMode { objList } {
  if {[info exists ::_skip_depreciated_] && ($::_skip_depreciated_ == 1)} {return}
  set valList [list ]
  foreach obj $objList {
    set pos [string last "/" $obj]
...
proc Axi_atu::get_crdMngrEn { objList } {
  if {[info exists ::_skip_depreciated_] && ($::_skip_depreciated_ == 1)} {return}
  set valList [list ]
  foreach obj $objList {
    set pos [string last "/" $obj]
...
proc Axi_atu::get_crdDataUnit { objList } {
  if {[info exists ::_skip_depreciated_] && ($::_skip_depreciated_ == 1)} {return}
  set valList [list ]
  foreach obj $objList {
    set pos [string last "/" $obj]
...
proc Axi_atu::get_timeoutErrChk { objList } {
  if {[info exists ::_skip_depreciated_] && ($::_skip_depreciated_ == 1)} {return}
  set valList [list ]
  foreach obj $objList {
    set pos [string last "/" $obj]
...
proc Axi_atu::get_timeoutErrCount { objList } {
  if {[info exists ::_skip_depreciated_] && ($::_skip_depreciated_ == 1)} {return}
  set valList [list ]
  foreach obj $objList {
    set pos [string last "/" $obj]
...
proc Axi_atu::get_timeoutUseExternalValue { objList } {
  set valList [list ]
  foreach obj $objList {
    set pos [string last "/" $obj]
    incr pos
...
proc Axi_atu::get_ctlPipeCtxt { objList } {
  if {[info exists ::_skip_depreciated_] && ($::_skip_depreciated_ == 1)} {return}
  set valList [list ]
  foreach obj $objList {
    set pos [string last "/" $obj]
...
proc Axi_atu::get_pipeLevelPam { objList } {
  set valList [list ]
  foreach obj $objList {
    set pos [string last "/" $obj]
    incr pos
...
proc Axi_atu::get_numPri { objList } {
  if {[info exists ::_skip_depreciated_] && ($::_skip_depreciated_ == 1)} {return}
  set valList [list ]
  foreach obj $objList {
    set pos [string last "/" $obj]
...
proc Axi_atu::get_pktArbType { objList } {
  if {[info exists ::_skip_depreciated_] && ($::_skip_depreciated_ == 1)} {return}
  set valList [list ]
  foreach obj $objList {
    set pos [string last "/" $obj]
...
proc Axi_atu::get_depktArbType { objList } {
  if {[info exists ::_skip_depreciated_] && ($::_skip_depreciated_ == 1)} {return}
  set valList [list ]
  foreach obj $objList {
    set pos [string last "/" $obj]
...
proc Axi_atu::get_pktArbWeights { objList } {
  set valList [list ]
  foreach obj $objList {
    set pos [string last "/" $obj]
    incr pos
...
proc Axi_atu::get_depktArbWeights { objList } {
  set valList [list ]
  foreach obj $objList {
    set pos [string last "/" $obj]
    incr pos
...
proc Axi_atu::get_smipktArbType { objList } {
  set valList [list ]
  foreach obj $objList {
    set pos [string last "/" $obj]
    incr pos
...
proc Axi_atu::get_smiPktweights { objList } {
  if {[info exists ::_skip_depreciated_] && ($::_skip_depreciated_ == 1)} {return}
  set valList [list ]
  foreach obj $objList {
    set pos [string last "/" $obj]
...
proc Axi_atu::get_smiDpkweights { objList } {
  if {[info exists ::_skip_depreciated_] && ($::_skip_depreciated_ == 1)} {return}
  set valList [list ]
  foreach obj $objList {
    set pos [string last "/" $obj]
...
proc Axi_atu::get_smiDpkarbType { objList } {
  if {[info exists ::_skip_depreciated_] && ($::_skip_depreciated_ == 1)} {return}
  set valList [list ]
  foreach obj $objList {
    set pos [string last "/" $obj]
...
proc Axi_atu::get_mstrArbLock { objList } {
  if {[info exists ::_skip_depreciated_] && ($::_skip_depreciated_ == 1)} {return}
  set valList [list ]
  foreach obj $objList {
    set pos [string last "/" $obj]
...
proc Axi_atu::get_lckStyleVld { objList } {
  if {[info exists ::_skip_depreciated_] && ($::_skip_depreciated_ == 1)} {return}
  set valList [list ]
  foreach obj $objList {
    set pos [string last "/" $obj]
...
proc Axi_atu::get_rateLmtEn { objList } {
  if {[info exists ::_skip_depreciated_] && ($::_skip_depreciated_ == 1)} {return}
  set valList [list ]
  foreach obj $objList {
    set pos [string last "/" $obj]
...
proc Axi_atu::get_rateLmtUseExternalValues { objList } {
  if {[info exists ::_skip_depreciated_] && ($::_skip_depreciated_ == 1)} {return}
  set valList [list ]
  foreach obj $objList {
    set pos [string last "/" $obj]
...
proc Axi_atu::get_rateLmtRefCntGlobal { objList } {
  if {[info exists ::_skip_depreciated_] && ($::_skip_depreciated_ == 1)} {return}
  set valList [list ]
  foreach obj $objList {
    set pos [string last "/" $obj]
...
proc Axi_atu::get_refreshAmtGlobal { objList } {
  if {[info exists ::_skip_depreciated_] && ($::_skip_depreciated_ == 1)} {return}
  set valList [list ]
  foreach obj $objList {
    set pos [string last "/" $obj]
...
proc Axi_atu::get_rateLmtBktGlobal { objList } {
  if {[info exists ::_skip_depreciated_] && ($::_skip_depreciated_ == 1)} {return}
  set valList [list ]
  foreach obj $objList {
    set pos [string last "/" $obj]
...
proc Axi_atu::get_enDecodeError { objList } {
  if {[info exists ::_skip_depreciated_] && ($::_skip_depreciated_ == 1)} {return}
  set valList [list ]
  foreach obj $objList {
    set pos [string last "/" $obj]
...
proc Axi_atu::get_wRateLmtRefCntGlobal { objList } {
  if {[info exists ::_skip_depreciated_] && ($::_skip_depreciated_ == 1)} {return}
  set valList [list ]
  foreach obj $objList {
    set pos [string last "/" $obj]
...
proc Axi_atu::get_wRefreshAmtGlobal { objList } {
  if {[info exists ::_skip_depreciated_] && ($::_skip_depreciated_ == 1)} {return}
  set valList [list ]
  foreach obj $objList {
    set pos [string last "/" $obj]
...
proc Axi_atu::get_wRateLmtBktGlobal { objList } {
  if {[info exists ::_skip_depreciated_] && ($::_skip_depreciated_ == 1)} {return}
  set valList [list ]
  foreach obj $objList {
    set pos [string last "/" $obj]
...
proc Axi_atu::get_wRateLmtRefCntQueue { objList } {
  if {[info exists ::_skip_depreciated_] && ($::_skip_depreciated_ == 1)} {return}
  set valList [list ]
  foreach obj $objList {
    set pos [string last "/" $obj]
...
proc Axi_atu::get_wRefreshAmtQueue { objList } {
  if {[info exists ::_skip_depreciated_] && ($::_skip_depreciated_ == 1)} {return}
  set valList [list ]
  foreach obj $objList {
    set pos [string last "/" $obj]
...
proc Axi_atu::get_wRateLmtBktQueue { objList } {
  if {[info exists ::_skip_depreciated_] && ($::_skip_depreciated_ == 1)} {return}
  set valList [list ]
  foreach obj $objList {
    set pos [string last "/" $obj]
...
proc Axi_atu::get_enPathLookup { objList } {
  if {[info exists ::_skip_depreciated_] && ($::_skip_depreciated_ == 1)} {return}
  set valList [list ]
  foreach obj $objList {
    set pos [string last "/" $obj]
...
proc Axi_atu::get_smiPktnumPri { objList } {
  if {[info exists ::_skip_depreciated_] && ($::_skip_depreciated_ == 1)} {return}
  set valList [list ]
  foreach obj $objList {
    set pos [string last "/" $obj]
...
proc Axi_atu::get_smiPktarbRdyAware { objList } {
  if {[info exists ::_skip_depreciated_] && ($::_skip_depreciated_ == 1)} {return}
  set valList [list ]
  foreach obj $objList {
    set pos [string last "/" $obj]
...
proc Axi_atu::get_smiPktweightsProg { objList } {
  if {[info exists ::_skip_depreciated_] && ($::_skip_depreciated_ == 1)} {return}
  set valList [list ]
  foreach obj $objList {
    set pos [string last "/" $obj]
...
proc Axi_atu::get_smiDpknumPri { objList } {
  if {[info exists ::_skip_depreciated_] && ($::_skip_depreciated_ == 1)} {return}
  set valList [list ]
  foreach obj $objList {
    set pos [string last "/" $obj]
...
proc Axi_atu::get_smiDpkarbRdyAware { objList } {
  if {[info exists ::_skip_depreciated_] && ($::_skip_depreciated_ == 1)} {return}
  set valList [list ]
  foreach obj $objList {
    set pos [string last "/" $obj]
...
proc Axi_atu::get_smiDpkweightsProg { objList } {
  if {[info exists ::_skip_depreciated_] && ($::_skip_depreciated_ == 1)} {return}
  set valList [list ]
  foreach obj $objList {
    set pos [string last "/" $obj]
...
proc Axi_atu::set_unit_attribute { ind procFunc value } {
  set unit [lindex $Axi_atu::created_units $ind]
  set x [$procFunc $unit $value]
}

proc Axi_atu::get_unit_attribute { ind procFunc } {
  set unit [lindex $Axi_atu::created_units $ind]
  set val [$procFunc $unit]
  return $val
}

proc Axi_atu::number_of_units { } {
  set val [llength $Axi_atu::created_units]
  return $val
}

proc Axi_atu::get_unit { indx } {
  if {$indx < 0 || $indx >= [llength $Axi_atu::created_units]} {
    return ""
  }
  set val [lindex $Axi_atu::created_units $indx]
  return $val
}

proc Axi_atu::set_clock { objList clk } {
  foreach unit $objList {
    update_object -name $unit -bind $clk -type "domain"
  }
}

proc Axi_atu::get_clock { objList } {
  set clks [list]
  foreach unit $objList {
...
proc Axi_atu::get_all_units { } {
  ...
  foreach atu $objects {
    ...
    if {[string compare $func "CONFIG_INTERFACE"] == 0} {
        lappend axiAtus $atu
    }
  }
  return $axiAtus
...
proc Axi_atu::get_units { list_of_indices } {
  set units [list]
  set objects [Axi_atu::get_all_units]
...
package provide Axi_atu $Axi_atu::version
